...
| `~/.openviking/codex-plugin.rc.sh`, `~/.openviking/codex-plugin/runtime/` | Residue of the pre-marketplace installer. The rc script, if still sourced, exports `OPENVIKING_*` and pins credentials to env mode. |
