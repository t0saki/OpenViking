 ...
 *
 * Usage:
 *   node ov-plugin-doctor.mjs [--json] [--offline] [--timeout <ms>] [--no-color]
 *
...
function checkInstall(report, { cliOnPath }) {
  ...
  if (existsPath(join(homedir(), ".openviking", "codex-plugin", "runtime"))) report.info("~/.openviking/codex-plugin/runtime is a leftover from the pre-marketplace installer (safe to delete)");
  return { listed };
}
