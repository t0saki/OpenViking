...
description: >
  ...
  OpenViking", "recall 为空", "401". Not for server-side health (embedding,
  VLM, storage) — that is `ov doctor`.
---

# OpenViking Memory Doctor (Codex)

Client-side troubleshooting for the OpenViking memory plugin. Three things go
