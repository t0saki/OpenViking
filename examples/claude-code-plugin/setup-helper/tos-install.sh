#!/usr/bin/env bash
#
# OpenViking Plugin for Claude Code — TOS bootstrap (China-friendly).
#
...
#
# One-liner:
#   bash <(curl -fsSL https://ovrelease.tos-cn-beijing.volces.com/claude-code-plugin/tos-install.sh)
#
# Env overrides:
...
export OPENVIKING_SHARED_INSTALL_URL="${OPENVIKING_SHARED_INSTALL_URL:-$TOS_BASE/plugin-shared/install.sh}"
