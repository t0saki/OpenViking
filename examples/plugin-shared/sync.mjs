...
export const SHARED_DIR = join(ROOT, "examples", "plugin-shared", "lib");
...
export const TARGETS = [
  {
    root: join(ROOT, "examples", "claude-code-plugin"),
    dir: join(ROOT, "examples", "claude-code-plugin", "scripts", "shared"),
    committed: true,
  },
  {
    root: join(ROOT, "examples", "codex-plugin"),
    dir: join(ROOT, "examples", "codex-plugin", "scripts", "shared"),
    committed: true,
  },
  {
  ...
  {
    root: join(ROOT, "examples", "dsh-plugin"),
    dir: join(ROOT, "examples", "dsh-plugin", "shared"),
    committed: false,
  },
  {
...
// canonical runtime to `$OV_HOME/agent-integrations/plugin-shared/lib`
...
export const GENERATED_HEADER = "// GENERATED FROM examples/plugin-shared/lib. DO NOT EDIT.\n";
...
export const SKILL_TARGETS = [
  ...
  {
    skill: "openviking",
    dir: join(ROOT, "examples", "codex-plugin", "skills"),
    committed: true,
  },
  {
    skill: "openviking",
    dir: join(ROOT, "examples", "claude-code-plugin", "skills"),
    committed: true,
  },
  {
    skill: "openviking",
  ...
  {
    skill: "openviking",
    dir: join(ROOT, "examples", "dsh-plugin", "skills"),
    committed: true,
  },
