...
const installer = join(ROOT, "examples", "plugin-shared", "install.sh");
const stageScript = join(ROOT, ".github", "scripts", "stage-plugin-marketplace.sh");
...
test("release marketplace archive supports a ZCode TOS install", () => {
  ...
  try {
    ...
    const sharedRoot = join(home, ".openviking", "agent-integrations", "plugin-shared", "lib");
