...
So in `/Users/x/Dev/OpenViking/examples/codex-plugin` with origin `git@github.com:volcengine/OpenViking.git`, the peer is `github.com-volcengine-openviking` — the same from any subdirectory, any worktree, any machine, any clone.
