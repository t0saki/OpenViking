...
| `recall_intent_timeout_s` | float | Timeout for opt-in session-aware recall query expansion. | `5.0` |
| `recall_rewrite_timeout_s` | float | Timeout for opt-in server-side recall digest rewriting. | `8.0` |
