...
| opencode | No takeover | v1 flushes and commits before compaction; v2 has no pre-compaction hook | v1 commits again on `session.compacted`; v2 commits once on `session.compaction.ended` |
